...
// The home-screen manifest and icons are the vessel's, and are written by the
// asset build itself (worker/scripts/build-assets.mjs) so that every way of
// making the assets writes them the same.
