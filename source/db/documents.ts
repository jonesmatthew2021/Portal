...
// Strong consistency: crew upload a file and click Open on it seconds later, so
// a read has to see the write immediately rather than eventually.
export function fileStore() {
  return getStore({ name: "crew-documents", consistency: "strong" });
}
