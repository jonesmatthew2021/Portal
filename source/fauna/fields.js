 ...
 *   sheetLabel?: string, options?: string[], required: "always" | "sighting" | "never",
...
/** @type {Field[]} */
export const FIELDS = [
  { key: "time", col: "A", label: "Time", sheetLabel: "Time", kind: "time", required: "always", group: "when" },
  { key: "date", col: "B", label: "Date", sheetLabel: "Date", kind: "date", required: "always", group: "when" },
  { key: "activity", col: "C", label: "Vessel activity", sheetLabel: "Vessel Activity", kind: "list", options: ACTIVITIES, required: "always", group: "vessel" },
  { key: "heading", col: "D", label: "Vessel heading", sheetLabel: "Vessel Heading (°)", kind: "number", unit: "°", required: "always", group: "vessel" },
  { key: "glare", col: "E", label: "Glare", sheetLabel: "Glare", kind: "list", options: range(0, 3), required: "always", group: "conditions" },
  { key: "visibility", col: "F", label: "Visibility", sheetLabel: "Visibility", kind: "list", options: range(1, 4), required: "always", group: "conditions" },
  { key: "windSpeed", col: "G", label: "Wind speed", sheetLabel: "Wind Speed (km/h)", kind: "number", unit: "km/h", required: "always", group: "conditions" },
  { key: "windDir", col: "H", label: "Wind direction", sheetLabel: "Wind Direction", kind: "text", required: "always", group: "conditions" },
  { key: "waveHeight", col: "I", label: "Wave height", sheetLabel: "Wave Height (m)", kind: "number", unit: "m", required: "always", group: "conditions" },
  { key: "cloud", col: "J", label: "Cloud cover (oktas)", sheetLabel: "Cloud Cover", kind: "list", options: range(0, 9), required: "always", group: "conditions" },
  { key: "light", col: "K", label: "Light", sheetLabel: "Light Conditions", kind: "list", options: LIGHT, required: "always", group: "conditions" },
  { key: "observer", col: "L", label: "Observer", sheetLabel: "Observer", kind: "text", required: "always", group: "when" },
  { key: "weather", col: "M", label: "Weather", sheetLabel: "Weather", kind: "list", options: WEATHER, required: "always", group: "conditions" },
  { key: "seaState", col: "N", label: "Sea state", sheetLabel: "Sea State", kind: "list", options: range(1, 9), required: "always", group: "conditions" },
  { key: "lat", col: "O", label: "Latitude", sheetLabel: "Lat", kind: "text", required: "always", group: "position" },
  { key: "long", col: "P", label: "Longitude", sheetLabel: "Long", kind: "text", required: "always", group: "position" },
  { key: "inZone", col: "Q", label: "Within monitoring zone", sheetLabel: "Is Marine Fauna within Monitoring Zone", kind: "yesno", required: "sighting", group: "animal" },
  { key: "faunaType", col: "R", label: "Fauna type", sheetLabel: "Fauna Type", kind: "list", options: FAUNA_TYPES, required: "sighting", group: "animal" },
  { key: "species", col: "S", label: "Species", sheetLabel: "Species", kind: "list", required: "sighting", group: "animal" },
  { key: "certainty", col: "T", label: "Species certainty", sheetLabel: "Species Certainty", kind: "list", options: CERTAINTY, required: "sighting", group: "animal" },
  { key: "total", col: "U", label: "Total number", sheetLabel: "Total No.", kind: "number", required: "sighting", group: "animal" },
  { key: "adults", col: "V", label: "Adults", sheetLabel: "Adults", kind: "number", required: "sighting", group: "animal" },
  { key: "calves", col: "W", label: "Calves or juveniles", sheetLabel: "Calves/ Juveniles", kind: "number", required: "sighting", group: "animal" },
  { key: "platformHeight", col: "X", label: "Observer platform height", sheetLabel: "Observer Platform Height (m)", kind: "number", unit: "m", required: "sighting", group: "vessel" },
  { key: "bearing", col: "Y", label: "Relative bearing", sheetLabel: "Relative Bearing (°)", kind: "number", unit: "°", required: "sighting", group: "animal" },
  { key: "distance", col: "Z", label: "Distance from vessel", sheetLabel: "Distance of animal from Vessel (m)", kind: "number", unit: "m", required: "sighting", group: "animal" },
  { key: "condition", col: "AA", label: "Animal condition", sheetLabel: "Animal Condition", kind: "list", options: CONDITIONS, required: "sighting", group: "animal" },
  { key: "behaviour", col: "AB", label: "Behaviour", sheetLabel: "Behaviour", kind: "list", options: BEHAVIOURS, required: "sighting", group: "animal" },
  { key: "action", col: "AC", label: "Action taken", sheetLabel: "Action Taken", kind: "text", required: "sighting", group: "response" },
  { key: "stopWork", col: "AD", label: "Stop work", sheetLabel: "Stop Work", kind: "yesno", required: "sighting", group: "response" },
  { key: "comments", col: "AE", label: "Comments", sheetLabel: "Comments", kind: "text", required: "never", group: "response" },
];
